var app = new Vue({
  ...
  data: {
    ...
    titles: ['Beautiful Milky Way', 'Wonderful Andromeda Galaxy', 'Amazing Whirlpool Galaxy', 'Wonderous Large Magellanic Cloud', 'Glorious Sombrero Galaxy', 'Legendary Messier 81', 'Astonishing Triangulum Galaxy', 'Stunning Black Eye Galaxy', 'Breathtaking Sagittarius Dwarf Spheroidal Galaxy', 'Astounding Virgo Stellar Stream', 'Marvelous Cosmos Redshift 7', 'Incredible Pinwheel Galaxy', 'Exciting Tadpole Galaxy', 'Thrilling Hoag\'s Object', 'Remarkable Small Magellanic Cloud', 'Spectactular Centaurus A' ],
    currentNumber: 0
  }, 
  methods: {
    getImages: function() {
